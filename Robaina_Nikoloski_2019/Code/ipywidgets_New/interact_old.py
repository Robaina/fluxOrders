...
def _get_html(obj):
    ...
    if png_rep is not None:
        ...
        img_elem = ('<img src="data:image/png;base64, '
                    + base64.b64encode(png_rep).decode() + '"/>') # you can load image here!
        return (img_elem)
    else:
...
class StaticInteract(object):
    ...
    <script type="text/javascript">
      ...
      if (typeof range_labels === "undefined") {{
          let range_labels;
      }}
      ...
      div = document.getElementById("static_widget");
      range_labels = div.getElementsByTagName("label");
